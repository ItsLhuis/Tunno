...
import { AuroraText, BorderBeam, Button, InView, Particles, Spotlight } from "@components/ui"
  ...
  return (
    <main className="relative size-full min-h-screen">
      ...
      <section className="relative z-10 mx-auto size-full max-w-full px-4 transition-all md:max-w-screen-xl md:px-12 lg:px-20">
        ...
        <InView className="relative w-full bg-transparent px-2 pt-20 pb-20 md:py-32">
