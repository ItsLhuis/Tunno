    ...
    <div className="flex items-center gap-2">
      <Sheet>
        ...
        <SheetTrigger asChild>
          <Button
            tooltip={t("playlists.filters.title")}
            variant="ghost"
            size="icon"
            className="relative"
          >
          ...
          <ScrollArea className="h-full">
            <div className="space-y-8 p-6">
              <div className="space-y-2">
                <Label className="text-sm font-medium">{t("playlists.filters.sortBy")}</Label>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="name">
                        {t("playlists.filters.sortOptions.name")}
                      </SelectItem>
                      <SelectItem value="isFavorite">
                        {t("playlists.filters.sortOptions.favorites")}
                      </SelectItem>
                      <SelectItem value="playCount">
                        {t("playlists.filters.sortOptions.playCount")}
                      </SelectItem>
                      <SelectItem value="lastPlayedAt">
                        {t("playlists.filters.sortOptions.lastPlayed")}
                      </SelectItem>
                      <SelectItem value="createdAt">
                        {t("playlists.filters.sortOptions.createdAt")}
                      </SelectItem>
                      <SelectItem value="updatedAt">
                        {t("playlists.filters.sortOptions.updatedAt")}
                      </SelectItem>
                      <SelectItem value="totalTracks">
                        {t("playlists.filters.sortOptions.totalTracks")}
                      </SelectItem>
                      <SelectItem value="totalDuration">
                        {t("playlists.filters.sortOptions.totalDuration")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <Select
              ...
              <div>
                <Label className="text-sm font-medium">{t("playlists.filters.playCount")}</Label>
              ...
              <div>
                <Label className="text-sm font-medium">{t("playlists.filters.totalTracks")}</Label>
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs text-muted-foreground">
              ...
              <div>
                <Label className="text-sm font-medium">
                  {t("playlists.filters.totalDuration")}
                </Label>
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs text-muted-foreground">
