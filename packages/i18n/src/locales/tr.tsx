      ...
      sync: {
        ...
        mobile: {
          ...
          cameraPermissionDescription:
            "Masaüstünüzde görüntülenen QR kodunu taramak için kamera izni verin",
          ...
          downloadingItem: '"{name}" indiriliyor',
          fetchingBatch: "Parti {batch} meta verileri getiriliyor",
