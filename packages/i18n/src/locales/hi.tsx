      ...
      sync: {
        ...
        mobile: {
          ...
          cameraPermissionDescription:
            "अपने डेस्कटॉप पर प्रदर्शित QR कोड स्कैन करने के लिए कैमरा अनुमति दें",
          ...
          downloadingItem: '"{name}" डाउनलोड हो रहा है',
          fetchingBatch: "बैच {batch} मेटाडेटा प्राप्त हो रहा है",
