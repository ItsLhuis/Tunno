      ...
      sync: {
        ...
        mobile: {
          ...
          cameraPermissionDescription:
            "Ge kamerabehörighet för att skanna QR-koden som visas på din dator",
          ...
          downloadingItem: 'Laddar ner "{name}"',
          fetchingBatch: "Hämtar metadata för batch {batch}",
