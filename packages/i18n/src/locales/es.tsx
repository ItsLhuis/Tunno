...
export const spanish: Language = {
  ...
  translations: {
    common: {
      ...
      featured: "Destacado",
      stats: "Estadísticas",
      openToStart: "Abrir Tunno para empezar"
    },
    form: {
      titles: {
      ...
      sync: {
        ...
        mobile: {
          ...
          cameraPermissionDescription:
            "Concede permiso de cámara para escanear el código QR mostrado en tu escritorio",
          ...
          downloadingItem: 'Descargando "{name}"',
          fetchingBatch: "Obteniendo metadatos del lote {batch}",
